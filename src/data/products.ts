...
export const products: Product[] = [
  ...
  },
  {
    ...
    descricao: "Malha premium com design italiano, perfeita para peças de alta qualidade. Disponível em 19 cores: Preto, Branco, Verde TW, Marrom, Ires, Pink, Amarelo BB, Frozen, Lavanda, Bic, Terra, Canela, Cronos, Marfim, Pimenta, Romance, Sanremo, Tibeton e Tulipero.",
