...
export const products: Product[] = [
  ...
  },
  {
    ...
    imagens: [
      ...
      "/lovable-uploads/poliside-azul-celeste-novo.jpg"
    ],
    descricao: "Versão premium do Poliside, com tecnologia avançada e acabamento superior. Disponível em 38 cores: Branco, Marfim, Preto, Azul BB, Bic, Marinho, Turquesa, Jade, Verde TW, Coral, Terra, Castanho, Canela, Sensuale, Erva Doce, Tame, Satim, Vermelho, Pimenta, Biscoito, Tibeton, Salmão, Romance, Pink, Ires, Rosa BB, Gris, Azul Celeste e mais 10 opções com novas versões de BIC e SENSUALE.",
