...
export const products: Product[] = [
  ...
  },
  {
    ...
    descricao: "Versão premium do Poliside, com tecnologia avançada e acabamento superior. Disponível em 28 cores: Branco, Marfim, Grafite, Preto, Azul BB, Bic, Marinho, Turquesa, Jade, Verde TW, Coral, Terra, Castanho, Canela, Sensuale, Erva Doce, Gris, Tame, Satim, Vermelho, Pimenta, Biscoito, Tibeton, Salmão, Romance, Pink, Ires e Rosa BB.",
