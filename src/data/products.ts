...
export const products: Product[] = [
  ...
  },
  {
    ...
    imagens: [
      ...
      "/lovable-uploads/poliside-denim.jpg",
    ...
    descricao: "Versão premium do Poliside, com tecnologia avançada e acabamento superior. Disponível em ampla gama de cores incluindo Branco, Marfim, Grafite, Turquesa, Coral, Gris, Castanho, Verde TW, Marinho, Tame, Jade, Satim, Azul BB, Canela, Preto, Bic, Denim, Terra, Sensuale, Salmão e Erva Doce.",
