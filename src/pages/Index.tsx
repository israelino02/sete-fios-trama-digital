        ...
        <div className="absolute bottom-8 left-0 right-0 z-20">
          <div className="container mx-auto px-4">
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Button asChild size="lg" className="bg-gradient-primary hover:scale-105 transition-all duration-300 shadow-warm text-lg px-8 py-6 h-auto font-semibold w-full sm:w-auto">
              ...
              <Button asChild size="lg" className="bg-white text-foreground hover:bg-primary hover:text-primary-foreground text-lg px-8 py-6 h-auto font-semibold hover:scale-105 transition-all duration-300 w-full sm:w-auto shadow-warm">
