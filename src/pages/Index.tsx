      ...
      <section className="py-6 bg-background">
        <div className="container mx-auto px-4">
          <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
            <Button asChild size="default" className="bg-primary hover:bg-primary/90 transition-colors duration-200 text-sm px-6 py-2.5 h-auto font-medium w-full sm:w-auto rounded-md">
            ...
            <Button asChild variant="outline" size="default" className="text-sm px-6 py-2.5 h-auto font-medium border-border hover:bg-muted transition-colors duration-200 w-full sm:w-auto rounded-md">
